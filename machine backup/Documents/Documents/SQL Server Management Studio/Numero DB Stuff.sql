select top 200 * from codeapi.TraceOutputs
where time > '2019-11-04T17:38:50' and time < '2019-11-04T17:39:50'
order by time desc
...
select * from stash.disputecase 
where numeroCustomerRef = 1001
--where numeroCustomerRef = 3001
--where numeroCustomerRef = 3
ORDER BY 1 DESC
...
where soapRequestText like '%15701199%'
ORDER BY 1 DESC
