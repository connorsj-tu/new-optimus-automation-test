...
where exceptionText = 'Selected Address for dispute not found in creditreport address links'
...
where soapRequestText like '%<CCCDisputeType>130%'
ORDER BY 1 DESC


select * from stash.soaprequests
where soapRequestText like '%10369465%'
ORDER BY 1 DESC
